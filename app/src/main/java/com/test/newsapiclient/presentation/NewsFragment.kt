...
import com.test.newsapiclient.databinding.FragmentNewsBinding
...
//        newsAdapter = NewsAdapter()
        binding.rvNews.apply {
            ...
            addOnScrollListener(this@NewsFragment.onScollListener)
        }
    }
    ...
    private val onScollListener = object : OnScrollListener(){
